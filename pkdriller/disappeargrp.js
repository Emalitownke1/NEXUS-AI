...
zokou({
  ...
  await _0xb269b7("*TREKKER-MD is sending this message to all groups you are in*...");
...
zokou({
  ...
  try {
    ...
    await _0x2e5b52("A moment, *TREKKER_MD* is compiling " + _0x267c2d.length + " contacts into a vcf...");
